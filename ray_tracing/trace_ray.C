...
{
  const Real EPSILON = 0.0000001;
  const VectorizedPoint & vertex0 = V00;
  const VectorizedPoint & vertex1 = V10;
  const VectorizedPoint & vertex2 = V11;

  const VectorizedPoint & rayOrigin = O;
  const VectorizedPoint & rayVector = D;

  VectorizedPoint edge1, edge2, h, s, q;
...
bool
Hand::rayIntersectsTriangleHand(const Vec3d & O,
                                const Vec3d & D,
                                const Vec3d & V00,
                                const Vec3d & V10,
                                const Vec3d & V11,
...
bool
Hand::intersectQuadUsingTrianglesHand(const Point & in_O,
                                      const Point & in_D,
                                      const Point & in_V00,
                                      const Point & in_V10,
                                      const Point & in_V11,
