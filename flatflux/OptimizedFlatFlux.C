...
OptimizedFlatFlux::OptimizedFlatFlux(std::vector<Real> & scalar_flux, std::vector<Real> & fsr_solution, std::vector<Real> & Q) :
    _dead_zone(0),
...
OptimizedFlatFlux::~OptimizedFlatFlux() {}

void
OptimizedFlatFlux::onSegment()
{
