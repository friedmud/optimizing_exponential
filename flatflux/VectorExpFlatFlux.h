...
#ifndef VECTOREXPFLATFLUX_H
#define VECTOREXPFLATFLUX_H
...
class VectorExpFlatFlux
{
public:
  VectorExpFlatFlux(std::vector<Real> & scalar_flux, std::vector<Real> & fsr_solution, std::vector<Real> & Q);
  virtual ~VectorExpFlatFlux();
