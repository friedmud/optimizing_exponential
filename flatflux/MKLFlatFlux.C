...
MKLFlatFlux::MKLFlatFlux(std::vector<Real> & scalar_flux, std::vector<Real> & fsr_solution, std::vector<Real> & Q) :
    _dead_zone(0),
...
MKLFlatFlux::~MKLFlatFlux() {}

void
MKLFlatFlux::onSegment()
{
...
*/
    vdExp(_exp_tau.size(), _exp_tau.data(), _exp_tau.data());
